...
const ProductModel = require('../models/productModel'); // Untuk dapatkan harga & stok
const CustomerModel = require('../models/customerModel'); // Validasi customer
...
const TransactionController = {
    ...
    createTransaction: async (req, res) => {
        ...
        try {
            ...
            // Tambahkan item dan update stok
            for (const item of processedItems) {
                await TransactionModel.addTransactionItem(transactionId, item.productId, item.quantity, item.pricePerItem);
                await ProductModel.update(item.productId, null, null, null, item.currentStock - item.quantity, null); // hanya update stok
            }
    ...
    // Mendapatkan semua transaksi milik customer
